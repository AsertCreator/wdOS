...
namespace wdOS.Core.Shells.ThirdParty
{
    ...
    // And finally modifed by me to make it a bit more readble and compatible with wdOS
    internal static class MIV
    {
        ...
        public static void StartMIV()
        {
            ...
            Console.WriteLine("Do you want to open " + CurrentFile + " content? (Yes/No)");
            ...
            if (text != null)
            {
                ...
                Console.WriteLine("Content has been saved to " + CurrentFile);
            }
