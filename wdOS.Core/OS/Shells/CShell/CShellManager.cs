...
{
    internal class CShellManager : Shell
    {
        ...
        {
            // handle mouse
            HandleSILMouse((int)Sys.MouseManager.X, (int)Sys.MouseManager.Y, Sys.MouseManager.MouseState);
        ...
        internal void HandleSILMouse(int x, int y, Sys.MouseState state)
        {
            FSC.DrawFilledRectangle(DefaultColors.BlackPen, x, y, CursorSize, CursorSize);
            if (state == Sys.MouseState.None)
        ...
        {
            int mx = (int)Sys.MouseManager.X, my = (int)Sys.MouseManager.Y;
