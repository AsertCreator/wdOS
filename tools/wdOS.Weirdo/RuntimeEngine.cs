...
namespace wdOS.Weirdo
{
    internal static class RuntimeEngine
    {
        ...
        internal static EEFunction[] GetBuiltinFunctions()
        {
            List<EEFunction> functions = new();

            CompilerEngine.CompileFile(@"function printImpl(arg){
    
}");

            return functions.ToArray();
        }
        internal static void SetupPillowEnvironment()
        {
