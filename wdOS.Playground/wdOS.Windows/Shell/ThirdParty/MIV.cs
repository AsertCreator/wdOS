...
namespace wdOS.Core.Shell.ThirdParty
{
    ...
    internal static class MIV
    {
        ...
        public static void StartMIV()
        {
            ...
            try
            {
                if (File.Exists(@"C:\" + CurrentFile))
                {
                    Console.WriteLine("Found file!");
                }
                else if (!File.Exists(@"C:\" + CurrentFile))
                {
                    Console.WriteLine("Creating file!");
                    File.Create(@"C:\" + CurrentFile);
                }
                Console.Clear();
            }
            catch (Exception ex)
            ...
            text = MIVMain(File.ReadAllText(@"C:\" + CurrentFile));

            Console.Clear();

            if (string.IsNullOrEmpty(text.Trim()))
            {
                File.WriteAllText(@"C:\" + CurrentFile, text);
